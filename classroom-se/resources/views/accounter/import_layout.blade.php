...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="{{ asset('css/addroom.css') }}"> <!-- Link to CSS file in the public directory -->
    <link rel="stylesheet" href="{{ asset('css/showroom.css') }}"> <!-- Link to CSS file in the public directory -->
...
<body>
  ...
  <div class="w3-sidebar w3-bar-block w3-card w3-animate-left w3-black " style="display:none" id="mySidebar">
    <header>
        <div class="image-text">
            ...
            <div class="text header-text" style="padding: 50px; text-align: center;">
              <span class="profession">ฝ่ายทะเบียน</span>
            </div>
    ...
    <a href="import_dropdown" class="w3-bar-item w3-button w3-padding-large w3-hover-blue">ลงทะเบียนหลักสูตรรายวิชา</a>
    <a href="addroom" class="w3-bar-item w3-button w3-padding-large w3-hover-blue">เพิ่มห้องเรียน</a>
    {{-- <a href="result" class="w3-bar-item w3-button w3-padding-large w3-hover-green">ตรวจสอบการลงทะเบียน</a> --}}
    <a href="managesbj" class="w3-bar-item w3-button w3-padding-large w3-hover-blue">ตรวจสอบรายวิชาที่พิจารณา</a>
...
<div id="main">
    ...
    <div style="padding: 3%">@yield('content')</div> 
    <script>
        function w3_open() {
