...
@section('content')
    ...
    <table class="table table-bordered border-black table-active text-center">
        <div class="">
            <div class="col-auto">
                <form action="/import_course55" method="GET">
                    ...
                    <a href="/import_create55" class="btn btn-success py-2" style="color: white;">เพิ่มรายวิชา</a> <br>
        ...
        <a>
            <h5 style="text-align:;">หลักสูตรปี 55 วิศวกรรมศาสตร์คอมพิวเตอร์และสารสนเทศศาสตร์</h5>
        </a>
        <thead>
            <tr>
        ...
        <tbody>
            @foreach ($course55 as $item)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('import_edit55', $item->course_id) }}" class="btn btn-warning btn-sm text-black"
                            onclick="confirmation1(event,'ยืนยันจะแก้ไขรายวิชา {{ $item->course_name }} นี้หรือไม่ ?')">
                            แก้ไข
                        </a>
                    </td>
                    <td>
                        <a href="{{ route('import_delete55', $item->course_id) }}" class="btn btn-danger btn-sm text-black"
