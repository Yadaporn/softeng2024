...
@section('content')
    ...
    <form id="myForm" method="POST" action="{{ route('import_update60', $course60->course_id) }}">
        @csrf
        <div class="form-group">
            <label for="idr">รหัสวิชา</label>
            <input type="text" name="idr" id="idr" class="form-control" value="{{ $course60->course_idr }}">
        </div>
        @error('idr')
            <div class="my -2">
        ...
        <div class="form-group">
            ...
            <input type="text" name="code" id="code" class="form-control" value="{{ $course60->course_code }}">
        </div>
        @error('code')
            <div class="my -2">
                <span class="text-danger">{{ $message }}</span>
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control" value="{{ $course60->course_name }}">
        </div>
        @error('name')
            <div class="my -2">
                <span class="text-danger">{{ $message }}</span>
        ...
        <div class="form-group">
            ...
            <input type="text" name="lec" id="lec" class="form-control" value="{{ $course60->course_lec }}">
        </div>
        @error('lec')
            <div class="my -2">
                <span class="text-danger">{{ $message }}</span>
        ...
        <div class="form-group">
            ...
            <input type="text" name="lab" id="lab" class="form-control" value="{{ $course60->course_lab }}">
        </div>
        @error('lab')
            <div class="my -2">
                <span class="text-danger">{{ $message }}</span>
        ...
        <div class="form-group">
            ...
            <input type="text" name="year" id="year" class="form-control" value="{{ $course60->course_year }}">
        </div>
        @error('year')
            <div class="my -2">
                <span class="text-danger">{{ $message }}</span>
