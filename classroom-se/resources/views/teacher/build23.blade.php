...
<body>
    <div class="top">
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $sql = 'SELECT COUNT(*) FROM status_build23 WHERE st_room = ? AND st_day = ? AND ((st_start < ? AND st_end > ?) OR (st_start < ? AND st_end > ?))';
        ...
        try {
            ...
            $stmt2 = $pdo->query("SELECT crs_room, crs_Number_of_students FROM tb_build WHERE crs_build = '23'");
                ...
                <div id="errorModal" class="modal" style="display: block;">
                    <div class="modal-content">
                        ...
                        <div class="button-container">
                            ...
                            <button type="button"onclick="window.location.href='statusbuild23';" class="status-btn">สถานะ</button>
                        </div>
                    </div>
                </div>
            @endif
