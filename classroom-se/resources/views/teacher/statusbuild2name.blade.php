...
<body>
    ...
    $total_items_query = 'SELECT COUNT(st_id) FROM status_build2 WHERE st_room LIKE ? OR st_day LIKE ? OR st_start LIKE ? OR st_end LIKE ? OR st_subjects LIKE ? OR st_teacher_name LIKE ?';
    ...
    $sql = 'SELECT * FROM status_build2 WHERE st_room LIKE ? OR st_day LIKE ? OR st_start LIKE ? OR st_end LIKE ? OR st_subjects LIKE ? OR st_teacher_name LIKE ? LIMIT ? OFFSET ?';
